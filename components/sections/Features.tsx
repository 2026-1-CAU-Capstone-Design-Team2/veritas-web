...
const features: Feature[] = [
  ...
  {
    eyebrow: "실시간 작성 보조 · 문서 에디터",
    hook: "근거 위에서 쓰고, 그 자리에서 다듬습니다.",
    body: "문서 개요·페이지(편집/미리보기/분할)·AI 도우미가 한 화면에 모인 마크다운 에디터입니다. 타이핑하는 동안 다음 문장을 흐릿한 고스트 텍스트로 미리 제안하고, 우측 AI 도우미는 검증된 워크스페이스 근거를 기반으로 대화·요약·문장 다듬기를 돕습니다. 조사·검증을 거친 초안을 '에디터로 보내기'로 이어받아 로컬에서 마무리합니다.",
    shot: shots.editor,
    tags: ["인라인 고스트라이팅", "근거 기반 AI 도우미", "편집 · 미리보기 · 분할 뷰"],
    icon: SquarePen,
  },
];
